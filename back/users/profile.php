...
if ($userId <= 0) {
    json_response(400, ['ok' => false, 'message' => 'Utilisateur invalide']);
}

$sql = 'SELECT id_user, nom, prenom, email, filiere, description, competences, image_profile FROM users WHERE id_user = :id_user LIMIT 1';
